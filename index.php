...
<header id="Home">
    ...
    <div class="container landing">
        <p class="mb-5"></p>
        <h1  
             class="title mt-5">Party Time</h1>
...
<Section id="Menu">
    ...
    <div class="menu-links row container mx-auto">
        ...
        <a  
             class="col my-0 mx-1 p-1" href="">pizza</a>
        <a   class="col my-0 mx-1 p-1" href="">fast food</a>
        <a  
             class="col my-0 mx-1 p-1" href="">cupcake</a>
    ...
    <div class="image-background">
        ...
        <img  
              class="w-100" src="Images/delivery.png" alt="delivery pizza guy" id="pizza-guy">
...
<div class="container">
    ...
    <Section id="Gallery">
        ...
        <div class="row justify-content-center ">
            ...
            <div <?php echo 100*$key ?>
                  class="card p-0   my-2 col-lg-2 col-md-4 col-11">
        ...
        <div class="Testimonials-content">
            ...
            <div class="row justify-content-center align-items-center">
                ...
                <div class=" col-lg-6 col-sm-11 ">
                   ...
                   <img class="d-block w-100" src="Images/man-eating-burger.png" >

                </div>
                <p class="col-lg-6 col-sm-11">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nobis nam aut deserunt minus--> provident aliquid maxime et? Nisi incidunt laborum beatae debitis. Voluptatibus, qui recusandae assumenda a minima vero  quasi.</p>
